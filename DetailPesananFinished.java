...
public class DetailPesananFinished extends AppCompatActivity {
    TextView txtSalesID, txtNama, txtTelp, txtAddress, txtPostalCode, txtSubtotalDetailPesanan, txtOngkirDetailPesanan, txtTotalDetailPesanan, txtWaktuPemesanan, txtWaktuPesananSelesai;
    ListView lv;
    ...
    String statusName, username, orderTime, finishedTime, receiverName, receiverPhone, receiverAddress, receiverPostalCode, productName;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detail_pesanan_finished);
        ...
        finishedTime = (String)bundle.get("finishedTime");
        ...
        txtWaktuPesananSelesai = findViewById(R.id.txtWaktuPesananSelesai);
        txtWaktuPesananSelesai.setText(finishedTime);

        list_items_pesanan = new ArrayList<>();
        lv = findViewById(R.id.list_items_detail_pesanan);

        RequestQueue queue = Volley.newRequestQueue(DetailPesananFinished.this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Configuration.URL_GET_DETAIL_SO, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (sukses == 1) {
                        ...
                        ListAdapter adapter_lv = new SimpleAdapter(DetailPesananFinished.this, list_items_pesanan, R.layout.list_cart, new String[]{"productName", "price_output", "quantity", "subtotal_output"}, new int[]{R.id.txtNamaProduk, R.id.txtPrice, R.id.txtQuantity, R.id.txtSubtotalProduk});
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(DetailPesananFinished.this, "Check your internet connection!", Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
        ...
        RequestQueue queue2 = Volley.newRequestQueue(DetailPesananFinished.this);
